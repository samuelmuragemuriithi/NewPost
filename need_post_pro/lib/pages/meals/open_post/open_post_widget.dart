...
class _OpenPostWidgetState extends State<OpenPostWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'OpenPost'});
              ...
              child: Stack(
                children: [
                                              ...
                                              children: [
                                                Align(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'OPEN_POST_PAGE_Icon_u6bzfisk_ON_TAP');
                                                      logFirebaseEvent(
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'OPEN_POST_PAGE_Icon_7d7kzkn2_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Icon_update_page_state');
                                                  _model.addToComents(_model
                                                      .textController.text);
                                                  setState(() {});
                                                  logFirebaseEvent(
                                                      'Icon_backend_call');
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(24.0, 54.0, 24.0, 0.0),
                      child: wrapWithModel(
